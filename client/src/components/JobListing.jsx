        ...
        {filteredJobs.length > 0 && (
          <div className="flex items-center justify-center space-x-2 mt-10">
              ...
              <button key={index + 1} onClick={() => setCurrentPage(index + 1)} disabled={currentPage===index+1}>
                <a
                  ...
                  className={`w-10 h-10 flex items-center justify-center border border-gray-300 rounded ${
                    currentPage === index + 1
                      ? "bg-blue-100 text-blue-500 cursor-not-allowed pointer-events-none"
                      : "text-gray-500"
                  }`}
                >
                  {index + 1}
            ...
            <a
              href="#job-list"
              onClick={(e) => {
                const maxPage = Math.ceil(filteredJobs.length / 6);
              ...
              aria-disabled={currentPage === Math.ceil(filteredJobs.length / 6)}
            >
